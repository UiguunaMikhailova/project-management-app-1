...
export const messages = {
  [LOCALES.RUSSIAN]: {
    ...
    role_one_description:
      'Настроила запросы к бэкенду через RTK Query, работу с состоянием Redux Toolkit, приватные Routes, реализовала создание, удаление, редактирование тасков в колонке, Drag-and-drop, поиск тасков пользователя, регистрацию пользователя, страницу Edit Profile',
